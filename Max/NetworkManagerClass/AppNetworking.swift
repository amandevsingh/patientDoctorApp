...
enum AppNetworking {
    ...
    static func GET(endPoint : String,
        ...
        request(URLString: endPoint, httpMethod: .get, parameters: parameters, encoding: URLEncoding.default, headers: headers, loader: loader, completion: completion)
    }
    ...
    static func PATCH(endPoint : String,
        ...
        fetchRequest(URLString: endPoint, httpMethod: .patch, parameters: parameters, encoding: encoding, headers: headers, loader: loader, completion: completion)
    }
    ...
    private static func fetchRequest(URLString : String,
        ...
        makeRequestForPatch(URLString: URLString, httpMethod: httpMethod, parameters: parameters, parameterArray: parameterArray, encoding: encoding, headers: headers, loader: loader, success: { (data) in
            if loader {
                DispatchQueue.main.async {
    ...
    private static func makeRequest(URLString : String,
        ...
        if !parameterArray.isEmpty {
            ...
            request.httpMethod = httpMethod.rawValue//"POST"
    ...
    private static func makeRequestForPatch(URLString : String,
                                httpMethod : HTTPMethod,
                                parameters : JSONDictionary = [:],
                                parameterArray: JSONDictionaryArray = [],
                                encoding: ParameterEncoding = JSONEncoding.default,
...
//        }
    ...
    //MARK: - Token Expired(Perform Action if token is expired)
...
public struct AttachmentInfo {
    ...
    public init(withImage image: UIImage, imageName: String, apiKey: String) {
        ...
        self.fileName = imageName + "." + (self.extens_string.count > 0 ? self.extens_string : "jpeg")
    }
