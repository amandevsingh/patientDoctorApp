...
@IBDesignable public class PinCodeTextField: UIView {
    ...
    @IBInspectable public var placeholderTextFeild: String?
    ...
    @IBInspectable public var characterBackgroundBorderWidth: CGFloat = 2
    @IBInspectable public var characterBackgroundBorderColor: UIColor = UIColor.clear
 ...
 */
    ...
    private func updateLabels() {
        let textHelper = TextHelper(text: text, placeholder: placeholderTextFeild, isSecure: isSecureTextEntry)
        for label in labels {
    ...
    private func updateBackgrounds() {
        for background in backgrounds {
            ...
            background.layer.borderWidth = characterBackgroundBorderWidth
            background.layer.borderColor = characterBackgroundBorderColor.cgColor
        }
    }
